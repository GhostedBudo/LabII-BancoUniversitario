            ...
            <div className={styles["login-container"]}>
                <div className={styles["form-section"]}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {/* 
             first_name: "usuario", -> TEXTO 
            last_name: "prueba", -> TEXTO
            document_number: "213123123", -> TEXTO
            birth_date: "2020-05-18T14:40:04.341364Z",-> CALENDAR
            phone_number: "+584245186631", -> TEXTO
             */}
                        {/* NOMBRE */}
                        <div className={styles["input-group"]}>
                            <label>Nombre</label>
